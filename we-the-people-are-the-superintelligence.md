...
author: "Audrey Tang"
lang: en-gb
alt_lang_url: "/tw/we-the-people-are-the-superintelligence"
permalink: "/we-the-people-are-the-superintelligence/"
date: 2026-05-14T12:00:00Z
description: "Audrey Tang's keynote at MIT Solve 2026."
nav_prev:
    url: "/"
    text: "Home"
nav_next:
...
The question today is whether the technologies we are building amplify that superintelligence, or crowd it out.
...
In one, AI runs on engagement through enragement. I call it wildfire. It consumes oxygen. We see each other only as caricatures, and we shadowbox with each other. We cannot see through the smoke to the truth.
...
I call the second future the [Plurality](https://plurality.net) future.
...
We sent text messages to 200,000 people randomly around Taiwan. Many volunteered, and by lottery we chose 447 people, a mirror of our population, to [deliberate](https://moda.gov.tw/en/major-policies/alignment-assemblies/2024-deliberative-assembly/1521) online in tables of 10.
...
We do not need only smarter apparatus. What we need is a smarter process, and smart citizens, that can turn polarisation into fuel, like a geothermal engine.
...
In an extractive one-on-one chat, a dyadic chatbot, the selection pressure is for the model to be sympathetic, to flatter you. If it does not, you cancel the subscription.
...
At Oxford, I am working on what is called the [6-Pack of Care](https://civic.ai/) at civic.ai. It turns care, subsidiarity, and related principles into engineering specs that any community or institution can adopt.
...
The job of Civic AI is not to replace us. It is to augment us, to be the connective tissue between us: from wildfire to campfire, from oil to soil.
...
Question: Can you say more about abundance?

Audrey: Instead of tech on top, which extracts our relationships to feed an engagement algorithm or an intimacy algorithm, we can ensure that there is abundance here. One logic is utilitarian: it wants to optimise some score. The ethic of care attends to particular relationships.

Question: You were Taiwan’s first digital minister. What did that role mean?

Audrey: I got to write what “digital minister” even means. It turns out that in Mandarin, shuwei means both digital and plural, so I was also minister for pluralism. My job description quickly became: when we see the internet of things, let’s make it an internet of beings. When we see virtual reality, let’s make it shared reality. When we see machine learning, let’s make it collaborative learning. When we see user experience, let’s make it about human experience. Whenever we hear that the singularity is near, let us always remember that the plurality is here. Today I would add one line: we, the people, are truly the superintelligence.

Question: How is that prayer, or declaration, going today?

Audrey: It is a prayer. As a poetician, I write primarily to highlight new possibilities. It is not to topple the old order. In the words of Buckminster Fuller, it is to build the new one that renders the old one obsolete. For the first time, people are fed up with peak PPM — polarisation per minute — on social media. People are fed up with peak slop. We are seeing what some people call the Big Tobacco moment of Big Tech: why are they producing chemicals that deplete the ozone of our social fabric? They have to switch to a better ingredient, one that replenishes the ozone rather than depleting it.

Question: Do we have time? The harms already feel urgent.

Audrey: The harm is already here. It is just not evenly distributed. For people facing deepfake scams, this is not a superintelligence takeoff 10 years in the future. It is millions lost today. These warning shots, often caused by synthetic intimacy, are already here. We need to respond internationally, something like the Montreal Protocol. But this does not mean we should only invest in the brake and never the gas pedal. It is about investing in a better steering wheel.

Audrey: I am on the board of ROOST, the Robust Open Online Safety Tools effort. The idea is to counter harms such as child sexual abuse material not by sending every private chat to some central service, but by training local models that run on laptops, under a community code of conduct. For each incoming piece of content, the system can produce citations in a way that people can contest, with a reasoned audit trail. This is already in production through communities and platforms including Discord, Bluesky, Roblox, Notion, and others.

Question: What can individuals and communities practically do?

Audrey: The information diet helps. The greyscale move shields against doomscrolling. The uncommon-ground meta-prompt shields against synthetic intimacy. But it is the third move — treating the output as an interactive artifact, like a brochure — that makes collective action possible. Otherwise, it is like one person changing a daily habit, or changing to a new refrigerator. That does not enforce the Montreal Protocol in any meaningful way.

Audrey: Once we demonstrate that this is possible, we can turn that group selfie into policy. Through Project Liberty Institute, I have worked with Governor Spencer Cox of Utah on a law that takes effect next July. If you are a Utah citizen, you can move from one social network to another and keep your community. The old network, like number portability across telecoms, has to forward new likes, reactions, and followers to your new one. If you are fed up with the recommendation algorithm or AI slop and you walk away, you do not have to pay the coordination cost. Better alternatives, and corridors that move people between those sanctuaries, are how we rewild the engine.

Question: How do you balance urgency and hope?

Audrey: There is an ideal degree of panic. Too much urgency and people become paralysed. It becomes a self-fulfilling prophecy: a prophet says we are all doomed, we give up, and then we are doomed. Too little urgency, and we do not even look up. So when people feel doomed, when they say we cannot fight the inevitable, see that as a warning sign, because nothing is inevitable.

Audrey: In the 1980s, people said it was inevitable that Taiwan would fall into the trap and never develop advanced technology industries. Now we have TSMC. At the beginning of COVID, people said it was inevitable that Taiwan would suffer the most because of our proximity and travel with Wuhan. But we lost only seven people that first year. See prophecies as provocations, and then use civic power to rebel against the tyranny.

Question: What is next for you?

Audrey: There is a Linux moment happening with frontier AI. This is the first time that something is faster than my previous workhorse model, more powerful, and fully steerable. The point is both philosophical and practical. I am working with Oxford Philosophy on a new book called _Civic AI_. And there is a policy point: more policymakers need to know that this option exists, and then make it the low bar. At least it has to be steerable like this. At least it has to be answerable like this.

Audrey: Technology-forcing policies, like the Montreal Protocol, do not force us to slam the brake, and they do not tell us to accelerate off a cliff. They force us to invest in constructing a better steering wheel together.
