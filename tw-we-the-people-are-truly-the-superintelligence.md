...
description: "唐鳳於 MIT Solve 2026 的主題演講。"
...
就在幾天前，我起草了一份指南，介紹如何用 [「pi-ds4」](https://audreyt.org/pi-ds4)做到這件事——完全在這台 MacBook 上以離線模式運行的前沿 AI stack，具備固定隨機種子、可重現的稽核軌跡，以及完整的方向性引導。
...
**Hala Hana**：這就是你對科技的看法嗎——那份豐盛？

**唐鳳**：是的。與其讓科技高高在上、抽取我們的關係去餵養某種互動演算法或親密感演算法，我們可以確保這裡有豐盛的關懷。一種邏輯是功利主義的，要最佳化某個分數。關懷倫理則照顧具體的關係。

**Hala Hana**：可以帶我們走過你當年為自己寫下、作為職務說明書的那首詩嗎——今天的你會改寫哪一句？

**唐鳳**：十年前，作為第一位數位部長，我得以書寫「數位部長」到底是什麼意思。在華語裡，「數位」同時意味著 digital，也意味著 plural，所以我也是多元主義部長。我的工作說明很快變成這樣：當我們看見物聯網，就讓它成為眾生聯網。當我們看見虛擬實境，就讓它成為共享實境。當我們看見機器學習，就讓它成為協作學習。當我們看見使用者體驗，就讓它關乎人的體驗。每當我們聽到奇點將近，就永遠記得多元宇宙已在這裡。今天，我會再加上一句：我們全民，才是超級智慧。

**Hala Hana**：世界上其他人——商業界、大型科技公司——是怎麼接受這份祈願的？
...
**Hala Hana**：我們還有時間嗎？難道一定要等到傷害發生才能行動？今天版本的臭氧公約，會長什麼樣子？
...
**Hala Hana**：你會請我們做什麼——不只是作為個人，而是作為一個集體？
