...
<noscript><img src="/img/pack5-1.jpg" alt="Hand-lettered comic page headed 'SOLIDARITY — PROBLEM' reading 'Don't put all your society in one basket': cartoon animals are first packed into a single purple basket and then the basket breaks apart, illustrating how routing modern culture, news and politics through a few multinational platforms creates a single point of failure and flattens the thick middle layer of churches and local communities; a row of identical grey figures stands below." class="overview-image" width="1024" height="1536" loading="lazy" decoding="async"></noscript>
...
<noscript><img src="/img/pack5-2.jpg" alt="Hand-lettered comic page headed 'NOT: mutually assured destruction, BUT: as win-win as possible — SOLUTION' urging 'fight for the users', with three examples — Utah's bipartisan law making social-media user data exportable and interoperable, the open-source local model GPT-OSS that lets a community bring its own policy, and the open-source ROOST tools for detecting child abuse — illustrated by a rabbit clutching a bundle marked 'MY DATA', a cat facing a 'Constitution' screen, and a winged reader, closing that these show how tech can distribute rather than concentrate power." class="overview-image" width="1024" height="1536" loading="lazy" decoding="async"></noscript>
