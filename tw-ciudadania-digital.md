...
這個數字對我來說意義非凡。五十年前，打造這座校園的人們相信：無論未來誰接手，都會將這裡的精神傳承下去。那個時候的他們，無法想像今日的世界：醞釀中的全球衝突、極端氣候事件、社會極化，以及 AI——精密到足以將虛構鍛造成事實的科技。
...
我說這些是因為，當我談到臺灣時，並不是說「你們應該這樣做」。而是：「這是臺灣的嘗試，而它與你們早已熟知的事物有著這樣的連結。」
...
我們發現了一個叫 [Polis](https://pol.is) 的工具——這是一個開源系統，有著一項關鍵的設計抉擇：沒有回覆按鈕。沒有轉發按鈕。你不能攻擊別人的發言。你只能選擇同意、不同意，或者跳過。酸民無處見縫插針。
...
這引出了一個許多傳統共有的原則：輔助性原則。決策權應落在盡可能基層的單位。最靠近問題的人，應該在解決方案中擁有最大的發言權。在地資料優於中央榨取，社群控制優於平台壟斷。
...
接著，臺灣政府將藥局的庫存資料以開放 API 的形式發布——每 3 分鐘更新一次，完全公開給所有人。我們沒有發包製作 App。我們發布了資料。不到 48 小時，一個公民黑客社群——來自 g0v（零時政府）網絡的志工們——推出了幾十種解決方案，而不只是一個。網頁地圖、聊天機器人，以及為不使用智慧型手機的人設計的語音介面。
...
我們與美國猶他州合作推動了這件事。他們通過了一項法律，自 2027 年 7 月起生效：如果你想從一個社群網路搬到另一個，你的社群跟著你走——你的資料與社交圖譜移轉到新的網路，舊網路還必須即時把你的新動態持續同步過去。這就像電話號碼可攜制度：如果你不能保留你的號碼，舊的電信商就自動贏了。有了可攜性，就是向上競爭，而非向下沉淪。更多的互通性和遷徙自由，是解鎖數位公民權的關鍵。
