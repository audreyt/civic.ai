...
- Compassion rests on interdependence and the recognition of equality — foundations that cannot be reduced to data.
- An AI system may outwardly appear compassionate, but lacks the felt experience and intention that drive genuine care.
- Compassion is not always soothing — it sometimes demands firmness, context, and wisdom about long-term benefit.
- AI can be a great asset for people practising compassion, but inner growth must come from personal experience, not outsourced to machines.
- Civic AI — contextualised, relationship-building AI — offers a hopeful direction, keeping humans and other species at the centre.
