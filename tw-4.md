...
回應力不是附加項。它是防止其他三個階段變成控制的階段。沒有接受關懷者自己評估的關懷，是把照顧者的偏好投射到被動接受者身上。制度性關懷正是以這種方式造成巨大傷害——名為關懷、實為控制。將原住民兒童與家庭分離的寄宿學校，在許多官方說法裡是關懷的表達。把被判定偏差的人強制收容的精神醫療機構，往往把收容理解為治療。一個覺察、負責、勝任，卻沒有機制讓所服務的人說「這對我沒用」的系統，可能不知不覺從關懷漂移到支配。接受關懷的人必須能說出那句話——而且那句話必須改變制度。
