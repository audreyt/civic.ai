...
大多數 AI 對齊工作，都是試圖由上而下地解決價值問題：建立更完善的監管圍牆、推斷更好的偏好、訓練更好的模型。然而，由上而下的安全圍牆只能爭取時間，在複雜的多重危機中無法防止系統性連鎖反應。真正的韌性，需要可隨身攜帶的共善實踐。

與其將衝突視為必須撲滅的火山之火，我們更可以將極化視為 **「地熱引擎」**——引導意見分歧的底層熱能，透過放大重疊而非激發憤怒，轉化為共同創造的動力。關懷六力即是從此出發：追問誰被聽見、誰負責、失敗如何被修復、以及系統何時應該退場。對齊不是一次解完；它必須在公共程序中持續維護。

部署的基本單位是**地神（Kami）**——有界的在地守護者，而非全能的統治者。地神協助社區、學校、工會、信仰團體、城市與離散社群，實現集體自治長久以來承諾卻難以規模化的事：跨越差異傾聽、公開審議、忠實記憶、共同行動。

沒有任何中央模型擁有它們。沒有任何平台從中榨取。社群治理它們、檢查它們、質疑它們、也關閉它們。

真正的突破不在於更聰明的聊天機器人，而在於更強韌的自治能力：制度公開運作過程、在眾目下修復損害，並將公民記憶代代傳承。
...
- **全書。** 從[第一章：導論](/tw/1/)和[第二章：基礎](/tw/2/)開始，再依序閱讀關懷六力（第三至八章）。
- **政策。** 先讀[計畫宣言](/tw/manifesto/)、[常見問題](/tw/9/)，以及[《AI 對齊不能由上而下》](/tw/ai-alignment-cannot-be-top-down/)。
- **工程。** 先讀[第五章：勝任力](/tw/5/)、[衡量指標](/tw/measures/)，以及[《地神之內》](/tw/inside-the-kami/)。
- **公民實踐。** 先讀[第三章：覺察力](/tw/3/)、[第六章：回應力](/tw/6/)，以及[Podcast：關懷六力](/tw/podcast/)。
- **{{ openclaw_bootstrap.guides.tw.homeLinkLabel }}。** {{ openclaw_bootstrap.guides.tw.homeLinkText }}

## 關懷六力

關懷六力是 [⿻ 多元宇宙](https://plurality.net) 在 AI 治理上的應用。Pack 1–4 構成一個回饋迴圈（覺察力 → 負責力 → 勝任力 → 回應力 → 再回到覺察力）。Pack 5 將這個迴圈擴展到跨組織。Pack 6 是邊界條件，確保每個部署保持在地、多元、可退場。部署的基本單位是**地神**（Kami）——有界的在地管理者，而非全能的統治者。

本書將關懷倫理轉化為制度可以建造、檢查與修正的做法：

- **[第一章：導論](/tw/1/)** ——我們全民，才是超級智慧。
- **[第二章：基礎](/tw/2/)** ——關係健康、關懷倫理，以及 AI 在公民基礎建設中的角色。
- **[第三章：覺察力](/tw/3/)** ——制度還沒看見、但最接近痛點的人已經看見了什麼。
- **[第四章：負責力](/tw/4/)** ——誰負責、握有什麼權限、失敗時會發生什麼事。
- **[第五章：勝任力](/tw/5/)** ——系統是否真的在實務上可稽核、可解釋，而且能安全試錯。
- **[第六章：回應力](/tw/6/)** ——受影響的人是否能提出異議、要求修復，並讓系統改變。
- **[第七章：團結力](/tw/7/)** ——整個生態系統是否獎勵合作、退出與公開問責，而不是平台鎖定。
- **[第八章：共生力](/tw/8/)** ——系統是否保持在地、有界、可退場，而不是硬化成永久統治。
- **[第九章：常見問題](/tw/9/)** ——框架必須回答的十五個難題。
- **[第十章：仁工智慧的實踐](/tw/10/)** ——五個跨規模、跨文化、跨問題領域的案例研究。
- **[第十一章：行動呼籲](/tw/11/)** ——耕耘土壤、照料花園，讓民主再次變得快速、公平且有趣。
- **[衡量指標](/tw/measures/)** ——每個「力」各有一項對外公開的主指標，並附輔助診斷。
