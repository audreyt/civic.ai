...
這些在地守護者有一個名字——**地神**（Kami，**K**nowledge 知識、**A**rtefact 工藝、**M**anagement 管理、**I**ntelligence 智慧）：是地方的精靈，而非全能的統治者。

大多數 AI「對齊」工作——也就是讓 AI 的行為符合人類價值的努力——都試圖由上而下地解決那些價值問題：寫出更好的規則、推斷更好的偏好、訓練更好的模型。這些工具很重要，但光靠它們並不夠。關懷六力從別的地方出發。它追問的是：誰被聽見、誰負責、失敗如何被修復、以及系統何時應該退場。對齊不是一次解完；它必須在公共程序中持續維護——可問責的公民程序，書中稱之為「以程序對齊」（alignment-by-process）。仁工智慧補足前沿對齊，不取代它，也無法在單一前沿模型內部解決控制問題。它治理的是部署型系統已經在行的房間——照護機構、教室、審議平台、地方議會——讓問責留在現場。

地神協助社區、學校、工會、信仰團體、城市與離散社群，實現集體自治長久以來承諾卻難以規模化的事：跨越差異傾聽、[公開審議](https://habermolt.com)、忠實記憶、共同行動。沒有任何中央模型擁有它們。沒有任何平台從中榨取。社群治理它們、檢查它們、質疑它們、也關閉它們。

真正的突破不是更聰明的聊天機器人，而是更強健的自治：制度公開運作過程、在眾目下修復損害，並將公民記憶代代傳承。超級智慧不需要降臨。它已經在這裡。它就是我們——不是說迷你公眾等同機器超級智慧，而是在正確的制度條件下，人加上工具，能產生可問責的集體智慧，沒有中央最佳化器能正當取代。這個主張已經夠強，不必再膨脹。
...
3. **看它如何運作。** [《AI 對齊不能由上而下》](/tw/ai-alignment-cannot-be-top-down/)講述臺灣如何回應一波 AI 詐騙廣告——框架在真實世界中的應用。
...
- **[Lean 形式化](/tw/formal-care/)**——機器可檢驗的骨架：六項具名關懷要素、前四力的關懷循環、第五力作為不可分解的團結力、第六力作為邊界條件。

## 四個切入案例

- **公共政策案例。** [《AI 對齊不能由上而下》](/tw/ai-alignment-cannot-be-top-down/)說明臺灣如何用對齊大會回應 AI 詐騙廣告。
- **技術案例。** [《地神之內》](/tw/inside-the-kami/)主張，有界且專精的系統比通用統治者更容易治理。
...
書中將這些擴展為七個案例研究：臺灣的對齊大會、日本的 Team Mirai（未來黨）、加州的 Engaged California、Monlam AI、ROOST 聯邦式安全網路——以及兩個書中坦承仍在起步階段的新興專案。這些案例真實且具名，卻來自異常有準備的土壤：公民科技者、具回應力的公共制度、厚實的結社生活。請把它們視為機制的證明，而非隨插即用的模板——在新房間裡，仍要重新問：誰缺席、誰有參與資格、誰能停下系統。Dedicate 是在英國扎根的社群系統，幫助無酬照顧者在同一個地方找到同儕、專家與在地服務。「提升老年人的聲音」（Lifting the Voices of Older Persons）則是一項全球傾聽行動，著手蒐集服務不足社群中老年人的優先事項，為聯合國正在協商的老年人權利新公約提供參考。
