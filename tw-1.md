...
Joan Tronto 稱覺察力為「暫時擱置自利，真正從需要者的角度去看的能力。」其反面，是她所命名的*特權式不負責*（privileged irresponsibility）：不去注意的特權。Tronto 寫道，相對享有特權的人被授予種種特權，「使人得以徑自忽視某些自己不必面對的困苦；我建議我們把這種特權形式稱為『特權式不負責』。」覺察力，就是拒絕這種特權的修練。
...
- **關係優先。** 關係是關懷的基本單位。特定角色與依存關係會使義務浮現。傾聽意味著提供安全的管道，以供人們自願表達並被承認，而不是被動監控或蒐集資料殘渣。監控是沒有關係的注意力；傾聽是在關係之中的注意力。
- **權力必須回答問題。** 決策應該可以解釋和挑戰。如果沒有人能質疑你，這個流程就不公平。
- **精確適可而止。** 從故事和人開始。當數字能讓事物更清晰時才加入；在現實改變時更新它們。
- **權利底線。** 這個計畫是在尊重權利的多元民主制度中，把關懷倫理落實為可操作的做法。我們以《世界人權宣言》加上當地憲法權利作為參與底線。權利與關懷並不對立；權利是取得關係立足地位的門檻條件——也是防止關懷變成支配的底線。
- **拒絕虛假多元。** 如果某人的基本存在正被抹除，他就無法以平等者身分參與搭橋。試圖抹滅他人立足地位的主張會被記錄，但不會設定議程。好客有其底線。

### 為何重要

許多 AI 計畫試圖從舊資料中「學習目標」。但共同目標來自變動生活中的協商。當被忽視的人們終於發聲時，目標會隨之轉變。試圖猜測出一個完美、固定的目標終將失敗。審議系統也必須知道一個聲音何時是人類、何時受影響、何時足夠可問責而能被計入——當參與可以被大規模偽造時，AI 會削弱這個假設。
...
6. **公布落差。** 在每一輪之前與之後回報代表性落差：哪些受實質影響的群體，仍然缺席或在紀錄中被嚴重低估。
...
- **傾聽。** 人們發送語音訊息、文字或前往自助服務站。訊息保留原始語言，並附上清晰的翻譯。Elena，一位房東從未給過正式租約、文件又在洪水中遺失的夜班醫院工作者，在自助服務站用母語錄下語音訊息：她沒有標準文件，但有鄰居和房東能為她作證。
- **繪製地圖。** 團隊將需求分類：住房、工資損失、證明文件障礙。讓分歧保持可見——租房者和房主需要不同的證明。
- **收據。** 每個貢獻者都收到連結，查看話語如何被使用，並附有「我不是這個意思」的按鈕。
- **公平排隊。** 對同時被標記為高需求、數位足跡又少的人——最可能是標準管道服務不到的人——優先安排真人審查。演算法不裁決個案；它只確保有真人及時查看。
...
- **程序性俘獲。** 流程領域的專業人士會摸熟提交規範；資源充足的組織會占據排隊的優先位置。
    - **修復方案：** 資助參與——有薪時間、托育、翻譯、社區中介——並追蹤誰缺席，而非僅追蹤誰出席。

### 介接

- **來自回應力（Pack 4）：** 修復循環和新發現的需求重啟整個循環。
- **來自共生力（Pack 6）：** 退役的智慧體會移交地圖、評估結果與收據，做為下一次第一眼的更佳基線。
- **對負責力（Pack 2）：** 覺察力會交接相關對象、執行事項與背後緣由——同時標註權利相關規範與未知事項。沒有覺察力，負責力只能在黑暗中運作；沒有負責力，覺察力就只是旁觀。
