...
- **Handover clause.** The contract stipulates a strict six-week sunset and handover: records and models transfer to the housing office; the switch-off is logged; the ledger is archived. The handover terms are fixed in the contract now; they execute automatically when the six weeks expire.
