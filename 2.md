...
Listening without acting is theatre. Acting without limits is arbitrary. Responsibility bridges the two by turning recognition into engagement with teeth — published promises you can verify, contest, and revoke, which still need authority and remedies before they bind.

In _[Moral Boundaries](https://www.routledge.com/Moral-Boundaries-A-Political-Argument-for-an-Ethic-of-Care/Tronto/p/book/9780415906425)_, Joan Tronto elevates responsibility as the most politically central phase of care, and in _[Caring Democracy](https://nyupress.org/9780814770344/caring-democracy/)_ (p. 46) she reframes democratic politics itself: not "who gets what, when and how" (Harold Lasswell's 1936 formula, as Tronto quotes it) but _"who is responsible for caring for what, when, where, and how."_ The shift replaces a distributive frame — who wins the allocation contest — with a relational one: who has made a binding commitment, to whom, and how do we know if they have kept it?

### Why it matters

Why must responsibility be explicit? Because power defaults to evasion — what Tronto names privileged irresponsibility (_Moral Boundaries_, pp. 120–121): the power to define which care obligations apply to you, and the habit of choosing the ones that cost least. In _[Caring Democracy](https://nyupress.org/9780814770344/caring-democracy/)_ she identifies five structural "passes" through which the evasion operates (named together on p. 33 and collected on pp. 169–171):
...
- **Clawbacks & penalties.** Breached promises are designed to trigger automatic remedies (escrow drawdown, withheld payment, probation). Publication alone does not enforce them.
...
- **Handover clause.** The contract stipulates a strict six-week sunset and handover: records and models transfer to the housing office; the switch-off is logged; the ledger is archived. The handover terms are written into the contract now; a clause is not yet a shutdown.

### A second case: the deepfake liability flywheel

The 2024 Taiwan deepfake-scam Assembly — 447 citizens, invited at scale then stratified among those who opted in, in 44 [Deliberative Polling](https://deliberation.stanford.edu/) groups on the Stanford Online Deliberation Platform, in the [Alignment Assembly](https://www.cip.org/alignmentassemblies) format developed with the Collective Intelligence Project — can be read as an Engagement Contract at civic scale, with one caveat the book presses: its force was institutional, a response path, not a pre-commitment to implement, and a mini-public is not the whole public. Pre/post surveys and the platform's own facilitation structured the protected tables. Room software handled queues, speaking time, turn order, and transcripts; it did not judge policy.

- **Contract.** The assembly recommended putting liability where capability sits: a platform shares the loss when an unsigned impersonation advert defrauds someone. The later [Fraud Crime Hazard Prevention Act](https://law.moj.gov.tw/ENG/LawClass/LawAll.aspx?pcode=D0080226) (amended 21 January 2026) did not enact that as-is. Article 30 requires platforms to verify the identity of persons commissioning and funding ads through digital signature, rapid authentication, or equivalent-safety methods — not specifically a signature of the featured celebrity. Article 32 attaches joint compensation to a platform that, knowing an ad is fraudulent or significantly involves fraud, fails notified removal, restriction, or suspension duties — not automatically to an unsigned likeness.
- **Brake.** The assembly recommended slowing video traffic 1% per day if a platform had no local representative to handle claims. Article 29 requires covered overseas platforms without a local establishment to designate a legal representative in Taiwan. Article 39: failure to designate, or a representative neglecting informing or assistance duties, can bring fines, then — after an expert process for serious cases — access or DNS restrictions, or traffic-management measures for serious failures of representative assistance, takedown, or suspension. That is not the 1%-per-day throttle as recommended.
- **Result.** The package earned roughly 85% support among the deliberants. What the assembly produced was a public record of reconsideration and actionable recommendations — a response path while an Executive Yuan bill was already moving — not citizen-authored statute. Taiwan's Ministry of Digital Affairs (moda) later reported identity-impersonation scam ads down more than 94% in the categories the Fraud Crime Hazard Prevention Act, reporting infrastructure, AI-ad scanning, and platform enforcement together touched — a near-collapse, but a targeted and multi-causal one.
...
- Tronto, _[Caring Democracy](https://nyupress.org/9780814770344/caring-democracy/)_ (2013), pp. 33, 46 and 169–171 — the five passes, the reframing of Lasswell, and their collection; _[Moral Boundaries](https://www.routledge.com/Moral-Boundaries-A-Political-Argument-for-an-Ethic-of-Care/Tronto/p/book/9780415906425)_ (1993), pp. 120–121 — privileged irresponsibility.
